...
import { DocumentComment, DocumentCommentSchema } from './schemas/document-comments.schema';
import { DocumentAnnotation, DocumentAnnotationSchema } from './schemas/document-annotations.schema';
import { CommentService } from './document.service';
import { CommentController } from './document.controller';
import { CommentReply, CommentReplySchema } from './schemas/comment-replies.schema';
